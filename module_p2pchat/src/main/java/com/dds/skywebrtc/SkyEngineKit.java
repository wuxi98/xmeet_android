...
public class SkyEngineKit {
    ...
    public static void init(ISkyEvent iSocketEvent) {
        if (avEngineKit == null) {
            ...
            PeerConnection.IceServer var11 = PeerConnection.IceServer.builder("stun:39.106.64.220:3478?transport=udp")
                    .createIceServer();
            ...
            PeerConnection.IceServer var13 = PeerConnection.IceServer.builder("turn:47.93.186.97:3478?transport=tcp")
                    ...
                    .setPassword("123456")
                    .createIceServer();*/
            PeerConnection.IceServer var12 = PeerConnection.IceServer.builder("turn:39.106.64.220:3478?transport=udp")
                    .setUsername("wuxi")
                    .setPassword("123456")
                    .createIceServer();
            PeerConnection.IceServer var13 = PeerConnection.IceServer.builder("turn:39.106.64.220:3478?transport=tcp")
                    .setUsername("wuxi")
                    .setPassword("123456")
                    .createIceServer();
