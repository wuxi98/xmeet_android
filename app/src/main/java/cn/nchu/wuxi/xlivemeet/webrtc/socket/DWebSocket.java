package cn.nchu.wuxi.xlivemeet.webrtc.socket;
...
public class DWebSocket extends WebSocketClient {
    ...
    public void onClose(int code, String reason, boolean remote) {
        Log.e("dds_error", "code:"+ code+" onClose:" + reason + "remote:" + remote);
        if (connectFlag) {
            try {
                Thread.sleep(3000);
    ...
    private void handleMessage(String message) {
        ...
        LogUtil.d(DWebSocket.class,"接收到："+message);
    ...
    public void createRoom(String room, int roomSize, String myId) {
        ...
        Log.d(TAG, "send-->" + childMap.toString());
    ...
    public void sendOffer(String myId, String userId, String sdp) {
        Log.d("wuxi_send_offer","myId="+myId+" userId="+userId);
        Map<String, Object> map = new HashMap<>();
        Map<String, Object> childMap = new HashMap<>();
